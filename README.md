...
To read a file and a entry within the file:

1. Add `import OLEKit` at the top of a relevant file.
2. Use `OLEFile(_ path: String)` to create a new instance with a path to your file.
